...
class QwenImagePipeline(BasePipeline):
        ...
        with init_empty_weights():
            ...
            for key, tensor in iterate_safetensors(transformer_path):
                ...
                try:
                    ...
                    print(f"[Warning] got {e} -> ignoring field and data.")
    ...
    def enable_block_swap(self, blocks_to_swap):
        ...
        assert blocks_to_swap <= num_blocks - 2, f"Cannot swap more than {
            num_blocks - 2
        } blocks. Requested {blocks_to_swap} blocks to swap."
        self.offloader = ModelOffloader(
            "TransformerBlock",
            blocks,
            num_blocks,
        ...
        print(
            f"Block swap enabled. Swapping {blocks_to_swap} blocks out of {
                num_blocks
            } blocks."
        )
